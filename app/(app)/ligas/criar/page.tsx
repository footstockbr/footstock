      ...
      <div className="px-4 pt-4 pb-10 max-w-lg mx-auto">
        ...
        >
          ...
          <p className="text-xs text-gray-400 leading-relaxed">
            ...
            Para criar liga de amigos, faça upgrade para{' '}
            <span className="text-[#F0B90B] font-medium">Craque</span>. Ligas{' '}
            <span className="text-[#F0B90B] font-medium">PRO</span> são exclusivas do plano{' '}
