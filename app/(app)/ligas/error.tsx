...
// ============================================================================
// Foot Stock — /ligas error boundary
// ============================================================================
...
export default function LigasError({
  error,
  reset,
}: {
      ...
      <div className="max-w-5xl mx-auto px-4 pt-4 pb-8">
        <div className="flex flex-col items-center justify-center gap-6 py-16 text-center">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-xl font-bold text-[#EAECEF]">Erro ao carregar ligas</h1>
            <p className="text-sm text-[#929AA5] max-w-sm">
              Não foi possível carregar as ligas. Verifique sua conexão e tente novamente.
            </p>
            {error.digest && (
