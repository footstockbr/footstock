...
// ============================================================================
// Foot Stock — /ligas/[id] error boundary
// ============================================================================
...
export default function LigaDetalheError({
  error,
  reset,
}: {
      ...
      <div className="max-w-5xl mx-auto px-4 pt-4 pb-8">
        <div className="flex flex-col items-center justify-center gap-6 py-16 text-center">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-xl font-bold text-[#EAECEF]">Erro ao carregar liga</h1>
            <p className="text-sm text-[#929AA5] max-w-sm">
              Não foi possível carregar os detalhes desta liga. Verifique sua conexão e tente novamente.
            </p>
            {error.digest && (
