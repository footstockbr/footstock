...
// ============================================================================
// Foot Stock — /assessor error boundary
// ============================================================================

import * as Sentry from '@sentry/nextjs'
import { useEffect } from 'react'
import Link from 'next/link'
import { BotOff, RefreshCw, TrendingUp } from 'lucide-react'
      ...
      <div className="max-w-5xl mx-auto px-4 pt-4 pb-8">
        <div className="flex flex-col items-center justify-center gap-6 py-16 text-center">
          <div className="w-16 h-16 rounded-full bg-[#F6465D]/10 flex items-center justify-center">
            <BotOff className="w-8 h-8 text-[#F6465D]" aria-hidden="true" />
          </div>

          <div className="flex flex-col gap-2">
            <h1 className="text-xl font-bold text-[#EAECEF]">Assessor IA indisponível</h1>
            <p className="text-sm text-[#929AA5] max-w-sm">
              O Assessor IA está temporariamente indisponível. Tente novamente em instantes.
            </p>
            {error.digest && (
