...
// ============================================================================
// Foot Stock — Portal do Clube error boundary
// ============================================================================
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="w-full max-w-md rounded-xl border border-white/10 bg-white/5 p-6 text-center">
        ...
        <h1 className="text-xl font-semibold text-zinc-100">Erro no portal do clube</h1>
        <p className="mt-2 text-sm text-zinc-400">
          Não foi possível carregar os dados do clube. Tente novamente ou faça login.
        </p>
