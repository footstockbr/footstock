...
export const CLUB_STATE_BY_TICKER: Record<string, string> = {
  ...
  REG3: 'RJ',  // Estrela do General Severiano (Botafogo-like)
  ...
  CRZ3: 'RJ',  // Cruz de Malta de Sao Januario (Vasco-like)
  BMP3: 'BA',  // Tricolor da Fonte Nova (Bahia-like)
  ...
  PEI3: 'SP',  // Baleia da Vila Belmiro (Santos-like)
  FUR3: 'PR',  // Furacao do Capao da Imbuia (Athletico PR-like)
  COX3: 'PR',  // Vovo Alemao do Couto (Coritiba-like)
  CON3: 'SC',  // Conda da Arena Verde (Chapecoense-like)
  RMO3: 'PA',  // Leao Azul do Baenao (Remo-like)
  LEA3: 'BA',  // Leao da Barra (Vitória-like)
  ...
  CBA3: 'MT',  // Dourado do Pantanal (Cuiabá-like)
