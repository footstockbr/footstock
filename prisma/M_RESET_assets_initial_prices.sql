...
SET
  current_price  = CASE
    ...
    WHEN ticker = 'MAC3' THEN  2.87
    WHEN ticker = 'ABT3' THEN  2.65
  ...
  market_cap     = CASE
    ...
    WHEN ticker = 'POR3' THEN  23100000.00
    ...
    WHEN ticker = 'LDI3' THEN   8290000.00
    ...
    WHEN ticker = 'MAC3' THEN   2870000.00
    WHEN ticker = 'ABT3' THEN   2650000.00
  ...
  financials     = jsonb_set(
    ...
    to_jsonb(CASE
      ...
      WHEN ticker = 'MAC3' THEN  2.87 WHEN ticker = 'ABT3' THEN  2.65
