...
export const ORDER_STATE_MACHINE: Readonly<Record<OrderStatus, readonly OrderStatus[]>> =
  Object.freeze({
    [ORDER_STATUS.OPEN]:      Object.freeze([ORDER_STATUS.FILLED, ORDER_STATUS.CANCELLED, ORDER_STATUS.EXPIRED]),
    [ORDER_STATUS.PARTIAL]:   Object.freeze([ORDER_STATUS.FILLED, ORDER_STATUS.CANCELLED, ORDER_STATUS.EXPIRED]),
    [ORDER_STATUS.FILLED]:    Object.freeze([] as OrderStatus[]),  // terminal
