...
- Name: tier2-technical-indicators.spec.ts >> T-011: Indicadores Tecnicos por Plano — TIER 2 >> TI-06: Stats do ativo exibem dados de mercado
- Location: tests/e2e/tier2-technical-indicators.spec.ts:109:7
...
```ts
  ...
  3   |  * FootStock / Verificacao E2E Completa de Todos os Gaps
  4   |  *
