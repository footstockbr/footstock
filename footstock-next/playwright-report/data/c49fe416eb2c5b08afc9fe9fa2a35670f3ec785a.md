...
- Name: tier1-circuit-breaker.spec.ts >> T-004: Circuit Breaker — TIER 1 >> CB-02: POST /api/v1/orders bloqueado durante halt — retorna erro HALT especifico
- Location: tests/e2e/tier1-circuit-breaker.spec.ts:51:7
