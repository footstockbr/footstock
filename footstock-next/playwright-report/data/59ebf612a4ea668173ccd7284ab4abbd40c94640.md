...
- Name: ui-interactions.spec.ts >> ST003: Formulário de Login — Validação e Feedback >> Submit com email inválido mostra erro de formato
- Location: tests/e2e/ui-interactions.spec.ts:173:7
