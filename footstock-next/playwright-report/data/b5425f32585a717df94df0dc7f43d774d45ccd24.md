...
- Name: tier2-cancellation-lock.spec.ts >> T-010: Cancelamento de Assinatura com Lock — TIER 2 >> CL-04: Cron de expiracao de lock responde 200 ou 401 (nao 500)
- Location: tests/e2e/tier2-cancellation-lock.spec.ts:82:7
...
Call log:
  - → POST http://localhost:3000/api/cron/cancellation-expiry
