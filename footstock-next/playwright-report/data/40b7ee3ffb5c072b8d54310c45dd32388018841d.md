...
- Name: e2e-flows.spec.ts >> F1: Cadastro → Onboarding → Dashboard >> Splash screen renderiza e redireciona para /login
- Location: tests/e2e/e2e-flows.spec.ts:79:7
...
- generic [active] [ref=e1]:
  - status "Carregando FootStock" [ref=e2]:
    - generic [ref=e3]:
      - img [ref=e4]
      - generic [ref=e5]:
        - heading [level=1] [ref=e6]: FootStock
        - paragraph [ref=e7]: O mercado do futebol
  - dialog "Consentimento de cookies" [ref=e12]:
    - generic [ref=e13]:
      - paragraph [ref=e14]:
        - text: Usamos cookies de analytics para melhorar sua experiência. Seus dados são pseudonimizados e nunca compartilhamos PII.
        - link "Política de Privacidade" [ref=e15] [cursor=pointer]:
          - /url: /privacidade
      - generic [ref=e16]:
