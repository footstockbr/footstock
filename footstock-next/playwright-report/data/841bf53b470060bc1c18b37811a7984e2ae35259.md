...
- Name: e2e-flows.spec.ts >> F1: Cadastro → Onboarding → Dashboard >> Login com credenciais válidas leva para /mercado ou /onboarding
- Location: tests/e2e/e2e-flows.spec.ts:105:7
