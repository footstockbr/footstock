...
const SERIE_A: AssetDef[] = [
  ...
  { ticker: 'TFN3', name: 'Tricolor da Fonte Nova FC',      clubSlug: 'fontenova',  division: 'SERIE_A', cluster: 'A_MID',   colorPrimary: '#2196F3', colorSecondary: '#CC0000', searchText: 'bahia ba tricolor esquadrao' },
  { ticker: 'BAL3', name: 'Baleia da Vila Belmiro FC',      clubSlug: 'baleia',     division: 'SERIE_A', cluster: 'A_MID',   colorPrimary: '#FFFFFF', colorSecondary: '#000000', searchText: 'santos sp peixe baleia vila belmiro' },

  // A_SMALL — 8 clubes de torcida intermediária/menor
  { ticker: 'MAL3', name: 'Cruz de Malta FC',               clubSlug: 'malta',      division: 'SERIE_A', cluster: 'A_SMALL', colorPrimary: '#000000', colorSecondary: '#CCCCCC', searchText: 'vasco rj cruz de malta sao januario' },
  ...
  { ticker: 'VOA3', name: 'Vovo Alemao do Couto FC',        clubSlug: 'vovo',       division: 'SERIE_A', cluster: 'A_SMALL', colorPrimary: '#006400', colorSecondary: '#FFFFFF', searchText: 'coritiba pr vovo coxa branca' },
...
const SERIE_B: AssetDef[] = [
  ...
  { ticker: 'DOU3', name: 'Dourado do Pantanal FC',         clubSlug: 'pantanal',   division: 'SERIE_B', cluster: 'B_ILLIQ',  colorPrimary: '#FFD700', colorSecondary: '#00823A', searchText: 'cuiaba mt dourado pantanal' },
