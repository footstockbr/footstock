...
const SERIE_A: AssetDef[] = [
  ...
  { ticker: 'POR3', name: 'Porco do Parque FC',             clubSlug: 'porco',      division: 'SERIE_A', cluster: 'A_TOP',   colorPrimary: '#006437', colorSecondary: '#FFFFFF', searchText: 'palmeiras sp porco verdao' },
  ...
  { ticker: 'TRI3', name: 'Tricolor do Morumbi FC',         clubSlug: 'tricolor',   division: 'SERIE_A', cluster: 'A_TOP',   colorPrimary: '#E30000', colorSecondary: '#FFFFFF', searchText: 'sao paulo fc sp tricolor morumbi' },

  // A_MID — 7 clubes de grande torcida
  { ticker: 'REG3', name: 'Estrela do General FC',          clubSlug: 'estrela',    division: 'SERIE_A', cluster: 'A_MID',   colorPrimary: '#1C1C1C', colorSecondary: '#E8E8E8', searchText: 'botafogo rj fogao estrela solitaria' },
  ...
  { ticker: 'GUE3', name: 'Guerreiro das Laranjeiras FC',   clubSlug: 'guerreiro',  division: 'SERIE_A', cluster: 'A_MID',   colorPrimary: '#6B0000', colorSecondary: '#00B140', searchText: 'fluminense rj flu tricolor das laranjeiras' },
  { ticker: 'BMP3', name: 'Tricolor da Fonte Nova FC',      clubSlug: 'fontenova',  division: 'SERIE_A', cluster: 'A_MID',   colorPrimary: '#2196F3', colorSecondary: '#CC0000', searchText: 'bahia ba tricolor esquadrao' },
  { ticker: 'PEI3', name: 'Baleia da Vila Belmiro FC',      clubSlug: 'baleia',     division: 'SERIE_A', cluster: 'A_MID',   colorPrimary: '#FFFFFF', colorSecondary: '#000000', searchText: 'santos sp peixe baleia vila belmiro' },

  // A_SMALL — 8 clubes de torcida intermediária/menor
  { ticker: 'CRZ3', name: 'Cruz de Malta FC',               clubSlug: 'malta',      division: 'SERIE_A', cluster: 'A_SMALL', colorPrimary: '#000000', colorSecondary: '#CCCCCC', searchText: 'vasco rj cruz de malta sao januario' },
  ...
  { ticker: 'COX3', name: 'Vovo Alemao do Couto FC',        clubSlug: 'vovo',       division: 'SERIE_A', cluster: 'A_SMALL', colorPrimary: '#006400', colorSecondary: '#FFFFFF', searchText: 'coritiba pr vovo coxa branca' },
  { ticker: 'LEA3', name: 'Leao da Barra FC',               clubSlug: 'barra',      division: 'SERIE_A', cluster: 'A_SMALL', colorPrimary: '#CC0000', colorSecondary: '#000000', searchText: 'vitoria ba leao rubro negro baiano' },
  ...
  { ticker: 'RMO3', name: 'Leao Azul do Baenao FC',         clubSlug: 'leaoazul',   division: 'SERIE_A', cluster: 'A_SMALL', colorPrimary: '#1C4FBF', colorSecondary: '#FFFFFF', searchText: 'remo pa leao azul baenao' },
]
...
const SERIE_B: AssetDef[] = [
  ...
  { ticker: 'LEP3', name: 'Leao do Pici FC',                clubSlug: 'leaopici',   division: 'SERIE_B', cluster: 'B_LIQUID', colorPrimary: '#CC0000', colorSecondary: '#1C4FBF', searchText: 'fortaleza ce leao pici tricolor cearense' },
  ...
  { ticker: 'IND3', name: 'Indio da Serra Gaucha FC',       clubSlug: 'indio',      division: 'SERIE_B', cluster: 'B_LIQUID', colorPrimary: '#006437', colorSecondary: '#CC0000', searchText: 'juventude rs indio gaucho' },
  ...
  { ticker: 'CAV3', name: 'Cavalo de Tiradentes FC',        clubSlug: 'cavalo',     division: 'SERIE_B', cluster: 'B_LIQUID', colorPrimary: '#1C4FBF', colorSecondary: '#FFFFFF', searchText: 'tombense mg cavalo tiradentes' },

  // B_ILLIQ — 10 clubes com baixa liquidez
  { ticker: 'LDI3', name: 'Leao da Ilha FC',                clubSlug: 'lhailha',    division: 'SERIE_B', cluster: 'B_ILLIQ',  colorPrimary: '#1C4FBF', colorSecondary: '#FFFFFF', searchText: 'avai sc leao ilha florianopolis' },
  { ticker: 'TIG3', name: 'Tigre do Heriberto FC',          clubSlug: 'heriberto',  division: 'SERIE_B', cluster: 'B_ILLIQ',  colorPrimary: '#CC0000', colorSecondary: '#FFFFFF', searchText: 'joinville sc tigre heriberto hulse' },
  { ticker: 'CBA3', name: 'Dourado do Pantanal FC',         clubSlug: 'pantanal',   division: 'SERIE_B', cluster: 'B_ILLIQ',  colorPrimary: '#FFD700', colorSecondary: '#00823A', searchText: 'cuiaba mt dourado pantanal' },
  ...
  { ticker: 'MAC3', name: 'Macaca do Majestoso FC',         clubSlug: 'macaca',     division: 'SERIE_B', cluster: 'B_ILLIQ',  colorPrimary: '#000000', colorSecondary: '#FFFFFF', searchText: 'ponte preta sp macaca majestoso' },
  { ticker: 'ABT3', name: 'Tigre do Grande ABC FC',         clubSlug: 'grandeabc',  division: 'SERIE_B', cluster: 'B_ILLIQ',  colorPrimary: '#CC0000', colorSecondary: '#000000', searchText: 'sao bernardo sp tigre abc' },
