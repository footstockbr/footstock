...
- Name: tier2-market-sessions.spec.ts >> T-008: Sessoes de Mercado — TIER 2 >> MS-04: GET /api/v1/market/assets retorna lista de ativos com volatilidade
- Location: tests/e2e/tier2-market-sessions.spec.ts:61:7
...
Call log:
  - → GET http://localhost:3000/api/v1/market/assets
