...
- Name: tier1-equity.spec.ts >> T-006: Equity Factor em Ligas — TIER 1 >> EQ-04: Liga OPEN aplica equity factor 1.40x para plano Jogador (verificacao de API)
- Location: tests/e2e/tier1-equity.spec.ts:119:7
