...
- Name: ui-interactions.spec.ts >> ST-MODAL: Modais — ESC, Backdrop, Botão X (TASK-4 ST003) >> Modal de confirmação fecha com botão X/Fechar
- Location: tests/e2e/ui-interactions.spec.ts:334:7
