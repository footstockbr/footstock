...
- Name: ui-interactions.spec.ts >> ST001: Bottom Tab Bar — Navegação Principal >> Bottom tab bar renderiza 5-6 links de navegação
- Location: tests/e2e/ui-interactions.spec.ts:73:7
