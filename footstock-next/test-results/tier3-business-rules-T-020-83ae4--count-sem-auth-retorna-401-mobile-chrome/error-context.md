...
- Name: tier3-business-rules.spec.ts >> T-020: Limites de Ordens — TIER 3 >> BR-08: GET /api/v1/orders/daily-count sem auth retorna 401
- Location: tests/e2e/tier3-business-rules.spec.ts:219:7
...
Call log:
  - → GET http://localhost:3000/api/v1/orders/daily-count
