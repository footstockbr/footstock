...
- Name: tier2-admin-modules.spec.ts >> T-012: Modulos do Admin — TIER 2 >> AM-01c: SUPER_ADMIN acessa modulo de configuracoes
- Location: tests/e2e/tier2-admin-modules.spec.ts:39:7
