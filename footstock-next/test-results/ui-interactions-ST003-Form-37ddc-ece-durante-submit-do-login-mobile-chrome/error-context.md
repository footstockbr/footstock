...
- Name: ui-interactions.spec.ts >> ST003: Formulário de Login — Validação e Feedback >> Loading state aparece durante submit do login
- Location: tests/e2e/ui-interactions.spec.ts:187:7
