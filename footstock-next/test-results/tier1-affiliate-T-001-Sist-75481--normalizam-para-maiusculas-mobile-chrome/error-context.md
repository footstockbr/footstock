...
- Name: tier1-affiliate.spec.ts >> T-001: Sistema de Afiliados — TIER 1 >> AF-01b: /ref/[codigo] e case-insensitive — minusculas normalizam para maiusculas
- Location: tests/e2e/tier1-affiliate.spec.ts:61:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/ref/pedro100
Call log:
  - navigating to "http://localhost:3000/ref/pedro100", waiting until "load"
