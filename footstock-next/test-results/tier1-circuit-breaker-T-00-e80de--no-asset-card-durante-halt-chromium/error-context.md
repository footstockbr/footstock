...
- Name: tier1-circuit-breaker.spec.ts >> T-004: Circuit Breaker — TIER 1 >> CB-03b: Badge "halted" visivel no asset-card durante halt
- Location: tests/e2e/tier1-circuit-breaker.spec.ts:114:7
