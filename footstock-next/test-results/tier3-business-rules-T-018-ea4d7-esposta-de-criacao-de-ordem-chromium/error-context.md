...
- Name: tier3-business-rules.spec.ts >> T-018: Taxa Operacional — TIER 3 >> BR-01: Headers de taxa diaria presentes na resposta de criacao de ordem
- Location: tests/e2e/tier3-business-rules.spec.ts:45:7
...
```ts
  1   | /**
  2   |  * TIER 3 — Regras de Negocio (T-018, T-019, T-020, T-021, T-023, T-024, T-026)
  3   |  * Foot Stock / T-033 Verificacao E2E Completa de Gaps
  4   |  *
  5   |  * Cenarios cobertos:
  6   |  *
  7   |  * TAXA OPERACIONAL (T-018):
