...
- Name: tier2-dividends.spec.ts >> T-007: Dividendos — TIER 2 >> DV-05: GET /api/v1/dividends sem auth retorna 401
- Location: tests/e2e/tier2-dividends.spec.ts:82:7
...
Call log:
  - → GET http://localhost:3000/api/v1/dividends
