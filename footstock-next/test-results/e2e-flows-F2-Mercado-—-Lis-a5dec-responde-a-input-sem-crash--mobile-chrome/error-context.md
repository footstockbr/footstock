...
- Name: e2e-flows.spec.ts >> F2: Mercado — Lista e Detalhe de Ativo >> Busca/filtro de ativos responde a input (sem crash)
- Location: tests/e2e/e2e-flows.spec.ts:169:7
