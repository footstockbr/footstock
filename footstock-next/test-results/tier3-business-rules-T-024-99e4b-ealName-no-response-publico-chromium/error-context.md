...
- Name: tier3-business-rules.spec.ts >> T-024: Nomes Ficticios — TIER 3 >> BR-14: GET /api/v1/assets nao expoe campo realName no response publico
- Location: tests/e2e/tier3-business-rules.spec.ts:325:7
