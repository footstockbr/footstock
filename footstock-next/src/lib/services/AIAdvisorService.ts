...
- Não inclua comentários, trailing commas, ou qualquer texto fora do JSON`)
  ...
  buildUserPrompt(ticker: string, context: AnalysisContext): string {
    ...
    return `Analise o ativo ${ticker} no mercado Foot Stock.
