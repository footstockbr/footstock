...
export const CLUBS_PUBLIC: PublicClub[] = [
  ...
  { ticker: 'BAL3', displayName: 'Baleia da Vila Belmiro SC',        division: 'SERIE_A' },
  { ticker: 'MAL3', displayName: 'Cruz de Malta de São Januário SC', division: 'SERIE_A' },
  ...
  { ticker: 'TFN3', displayName: 'Tricolor da Fonte Nova FC',        division: 'SERIE_A' },
