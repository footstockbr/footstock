...
const SERIE_A: Record<string, IpoPricingEntry> = {
  ...
  POR3: { fairValue: 36.76, shares: 20_900_000, rating: 'BBB' },  // Palmeiras
...
const SERIE_B: Record<string, IpoPricingEntry> = {
  LEP3: { fairValue: 12.00, shares: 8_100_000,  rating: 'BB' },   // Fortaleza
  ...
  LDI3: { fairValue: 7.00,  shares: 150_000,    rating: 'C' },    // Avaí
  ...
  MAC3: { fairValue: 3.75,  shares: 100_000,    rating: 'E' },    // Ponte Preta
  NAF3: { fairValue: 3.75,  shares: 100_000,    rating: 'E' },    // Náutico
  ABT3: { fairValue: 3.00,  shares: 4_900_000,  rating: 'BBB', estimated: true }, // São Bernardo (analogia)
  TUB3: { fairValue: 3.22,  shares: 2_050_000,  rating: 'BBB' },  // Londrina
  CAV3: { fairValue: 3.03,  shares: 1_950_000,  rating: 'BB' },   // Athletic Club
}
