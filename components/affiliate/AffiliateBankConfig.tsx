'use client'
// ============================================================================
// Foot Stock — AffiliateBankConfig
// Formulário de dados bancários do influenciador afiliado para repasse.
// Reutiliza padrão de AffiliateConfig (club portal) com endpoint diferente.
...
interface InitialBankData {
  banco: string
  agencia: string
  conta: string   // mascarado
  pixKey: string
  cpfCnpj?: string    // mascarado (opcional: pode vir como cnpj)
  cnpj?: string       // alias para cpfCnpj quando retornado pela API
}

interface AffiliateBankConfigProps {
  initialData?: InitialBankData | null
}

export function AffiliateBankConfig({ initialData }: AffiliateBankConfigProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-zinc-500">
        Informações para repasse das suas comissões. Armazenados com criptografia.
      </p>
